		...
		<table class="system-status-table">
			<tbody>
				...
				<tr>
					...
					if ( $memory < 134217728 ) {
						echo '<mark class="error">' . sprintf(__('%s - We recommend setting memory to at least 128MB. %s.','edubin'), size_format( $memory ), '<a href="' . esc_url('https://thepixelcurve.com/how-to-increase-memory-limit-for-wordpress-site/') . '" target="_blank">'.esc_html__('More info','edubin').'</a>') . '</mark>';
					} else {
