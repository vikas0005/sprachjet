...
class RTEC_Admin
{
	...
	public function form_fields_description() {
		?>
            <p><?php echo sprintf( __( 'Create unlimited forms and form fields by %supgrading to pro%s.', 'registrations-for-the-events-calendar' ), '<a href="https://roundupwp.com/products/registrations-for-the-events-calendar-pro/?utm_campaign=rtec-free&utm_source=form-settings&utm_medium=unlimited-forms&utm_content=UpgradingToPro" target="_blank">', '</a>' ); ?></p>
        <?php
	}
