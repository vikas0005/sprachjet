...
class Edubin_Widgets_Control
{
    ...
    public function edubin_widgets_control()
    {
        ...
        require_once EDUBIN_ADDONS_PL_PATH . 'includes/widgets/section_5.php';
        $widgets_manager->register_widget_type(new \Elementor\Edubin_Elementor_Widget_Section_5());

        require_once EDUBIN_ADDONS_PL_PATH . 'includes/widgets/section_6.php';
        $widgets_manager->register_widget_type(new \Elementor\Edubin_Elementor_Widget_Section_6());
        ...
        require_once EDUBIN_ADDONS_PL_PATH . 'includes/widgets/programs.php';
        $widgets_manager->register_widget_type(new \Elementor\Edubin_Elementor_Widget_Programs());
      ...
      require_once EDUBIN_ADDONS_PL_PATH . 'includes/widgets/countdown.php';
        ...
        if (is_plugin_active('mailchimp-for-wp/mailchimp-for-wp.php')) {
            require_once EDUBIN_ADDONS_PL_PATH . 'includes/widgets/mailchimp.php';
            $widgets_manager->register_widget_type(new \Elementor\Edubin_Mail_Chimp());
        }
