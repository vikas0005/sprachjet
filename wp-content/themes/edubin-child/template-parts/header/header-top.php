                    ...
                    <?php if (!empty($custom_profile_page_link)) : ?>
                        <li class="profile">
                            ...
                            if(in_array('partner', $roles)) { ?>
                                <a href="<?php echo site_url('partner-dashboard'); ?>"><?php if($top_profile_button_text) : echo $top_profile_button_text; else : echo esc_html__( 'Profile', 'edubin' ); endif; ?></a>
                            <?php } else { ?>
                ...
                <div class="login-register">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li><a href="<?php echo site_url('customer-login'); ?>">Customer</a></li>
                          <li><a href="<?php echo site_url('partner-login'); ?>">Partner</a></li>
                        </ul>
                    </div>
