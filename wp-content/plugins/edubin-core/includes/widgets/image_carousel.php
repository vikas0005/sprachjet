...
class Edubin_Elementor_Widget_Icon_Category extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .edubin-icon-category-style-1 .edubin-icon-category .single-category' => 'height: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .edubin-icon-category-style-2 .edubin-icon-category .single-category' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .edubin-icon-category-style-1 .edubin-icon-category .single-category' => 'width: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .edubin-icon-category-style-2 .edubin-icon-category .single-category' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px'],
                'selectors' => [
                    '{{WRAPPER}} .edubin-icon-category-style-1 .edubin-icon-category .single-category' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .edubin-icon-category-style-2 .edubin-icon-category .single-category' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .edubin-icon-category-style-3 .edubin-icon-category .single-category' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'border',
                'selector' => '{{WRAPPER}} .edubin-icon-category-style-2 .slick-slide .edubin-icon-category .single-category',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .edubin-icon-category-style-2 .slick-slide .edubin-icon-category .single-category' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .edubin-icon-category-style-2 .slick-arrow' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .edubin-icon-category-style-3 button.slick-arrow' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}} .edubin-icon-category-style-2 .slick-arrow' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .edubin-icon-category-style-3 button.slick-arrow' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .edubin-icon-category-style-1 .slick-arrow',
                    '{{WRAPPER}} .edubin-icon-category-style-2 .slick-arrow',
                    '{{WRAPPER}} .edubin-icon-category-style-3 button.slick-arrow',
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .edubin-icon-category-style-2 .slick-arrow' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    '{{WRAPPER}} .edubin-icon-category-style-3 button.slick-arrow' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}} .edubin-icon-category-style-2 .slick-arrow' => 'height: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .edubin-icon-category-style-3 button.slick-arrow' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}} .edubin-icon-category-style-2 .slick-arrow' => 'width: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .edubin-icon-category-style-3 button.slick-arrow' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}} .edubin-icon-category-style-2 .slick-arrow' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .edubin-icon-category-style-3 button.slick-arrow' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator'  => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .edubin-icon-category-style-2 .slick-arrow:hover' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .edubin-icon-category-style-3 button.slick-arrow:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types'    => ['classic', 'gradient'],
                'selectors' => [
                    '{{WRAPPER}} .edubin-icon-category-style-1 .slick-arrow:hover',
                    '{{WRAPPER}} .edubin-icon-category-style-2 .slick-arrow:hover',
                    '{{WRAPPER}} .edubin-icon-category-style-3 button.slick-arrow:hover',
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .edubin-icon-category-style-2 .slick-arrow:hover' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    '{{WRAPPER}} .edubin-icon-category-style-3 button.slick-arrow:hover' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types'    => ['classic', 'gradient'],
                'selectors' => [
                    '{{WRAPPER}} .edubin-icon-category-style-1 .slick-dots li',
                    '{{WRAPPER}} .edubin-icon-category-style-2 .slick-dots li',
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .edubin-icon-category-style-2 .slick-dots li' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}} .edubin-icon-category-style-2 .slick-dots li' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}} .edubin-icon-category-style-2 .slick-dots li' => 'width: {{SIZE}}{{UNIT}} !important;',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types'    => ['classic', 'gradient'],
                'selectors' => [
                    '{{WRAPPER}} .edubin-icon-category-style-1 .slick-dots li.slick-active',
                    '{{WRAPPER}} .edubin-icon-category-style-2 .slick-dots li.slick-active',
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .edubin-icon-category-style-2 .slick-dots li.slick-active' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                ],
            ]
        );
    ...
    <?php if( $settings['image_carosul_style'] == '1' ): ?>
        <div class=" edubin-icon-category-style-<?php echo $settings['image_carosul_style']?>"> 
    ...
    <?php elseif( $settings['image_carosul_style'] == '2' ): ?>
        <div class="edubin-icon-category-style-<?php echo $settings['image_carosul_style']?> <?php if ($settings['sldots']=='yes'): echo 'edubin-carousel-dot-1'?> <?php endif?>"> 
            <div <?php echo $this->get_render_attribute_string('edubin_carosul_attr'); ?> >
    ...
    <?php elseif( $settings['image_carosul_style'] == '3' ): ?>
        <div class="edubin-icon-category-style-<?php echo $settings['image_carosul_style']?> <?php if ($settings['slarrows']=='yes'): echo 'edubin-carousel-nav-1'?> <?php endif?>"> 
            <div <?php echo $this->get_render_attribute_string('edubin_carosul_attr'); ?> >
                    ...
                    <?php endif;?>
                        <div class="edubin-icon-category">
                            <div class="single-category text-center" style="background: <?php echo esc_attr__($imagecarosul['bg_colors']); ?>">
                                   ...
                                   <div class="img-wrapper" style="border-color: <?php echo esc_attr__($imagecarosul['border_colors']); ?>">
                                        <?php echo Group_Control_Image_Size::get_attachment_image_html($imagecarosul, 'carosul_imagesize', 'carosul_image'); ?>
                                   </div>
