...
$is_same_start_end = $formatted_start_date == $formatted_end_date && $formatted_start_time == $formatted_end_time;
    ...
    $tbe_content_before_massage = Edubin::setting( 'tbe_content_before_massage' ); 
    $tbe_content_after_massage = Edubin::setting( 'tbe_content_after_massage' ); 
    $edubin_tribe_events_layout = Edubin::setting( 'edubin_tribe_events_layout' );
