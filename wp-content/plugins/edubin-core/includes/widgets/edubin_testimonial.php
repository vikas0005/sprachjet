            ...
            $this->add_control(
                ...
                [
                    ...
                    'options' => [
                        ...
                        '7'   => __( 'Style 7', 'edubin-core' ),
                        '8'   => __( 'Style 8', 'edubin-core' ),
                    ],
                ]
            );
            $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .edubin-testi-8 .edubin-testi-single .testimonial-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
    ...
    <?php if( $settings['testi_style'] == 1 ): ?>     
        ...
        <?php elseif( $settings['testi_style'] == 6 ): ?>
            <div <?php echo $this->get_render_attribute_string( 'testimonial_area_attr' ); ?>>
                ...
                <?php endforeach; ?>
            </div> <!-- End testimonial style 6 -->
            
            
        <?php elseif( $settings['testi_style'] == 7 ): ?>
            <div <?php echo $this->get_render_attribute_string( 'testimonial_area_attr' ); ?>>
                <?php foreach ( $settings['edubin_testimonial_list'] as $testimonial ) :?>
                    <div class="edubin-testi-single layout-7">
                            ...
                            <div class="testimonial-cont">
                                ...
                                <?php if ( $settings['quote_show_hide']) : ?>
                                   <?php if ( $settings['quote_style'] == '1'): ?>
                                    ...
                                    <?php elseif ( $settings['quote_style'] == '2'): ?>
                                        <div class="quote-bg"><i class="flaticon-quote-left"></i></div>
                                    <?php endif; ?>
                                <?php endif; ?>
                                <?php
                                    if( !empty($testimonial['client_say_heading']) ){
                ...
                <?php endforeach; ?>
            </div> <!-- End testimonial style 7 -->


            <?php elseif( $settings['testi_style'] == 8 ): ?>
            <div <?php echo $this->get_render_attribute_string( 'testimonial_area_attr' ); ?>>
                <?php foreach ( $settings['edubin_testimonial_list'] as $testimonial ) :?>
                    <div class="edubin-testi-single layout-8">
                        <div class="testimonial-wrapper">
                            <div class="testimonial-thum">
                                <?php
                                    if( !empty($testimonial['client_image']['url']) ){
