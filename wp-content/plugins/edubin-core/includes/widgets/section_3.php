                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="hero-content">
                            <?php if ($settings['heading']): ?>
                                <h2 class="title" data-aos="fade-up" data-aos-delay="500"><?php echo $settings['heading']; ?></h2>
                            <?php endif ?>
                            <?php if ($settings['sub_heading']): ?>
                                <p class="sub-title" data-aos-delay="700" data-aos="fade-up"><?php echo $settings['sub_heading']; ?></p>
                            <?php endif; ?>
                            <?php if ($settings['show_button']): ?>
                                <a class="here-btn edubin-btn-3" data-aos-delay="900" data-aos="fade-up" <?php echo ($settings['button_link']["is_external"] == 'on') ? 'target="_blank"' : '' ; ?> href="<?php echo esc_url($settings['button_link']['url']); ?>"><?php echo $settings['button_text']; ?></a>
                            <?php endif; ?>
