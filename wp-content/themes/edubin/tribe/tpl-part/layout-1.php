<?php
    ...
    $show_event_time = Edubin::setting( 'show_event_time' );
    $show_event_end_date = Edubin::setting( 'show_event_end_date' );
    $show_event_vanue = Edubin::setting( 'show_event_vanue' );
    $events_title_word = Edubin::setting( 'events_title_word' );
