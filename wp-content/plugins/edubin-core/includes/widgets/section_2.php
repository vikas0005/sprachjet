                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="hero-content">
                            <?php if ($settings['sub_heading']): ?>
                                <h3 class="sub-title" data-aos-delay="500" data-aos="fade-up"><?php echo $settings['sub_heading']; ?></h3>
                            <?php endif ?>
                            <?php if ($settings['heading']): ?>
                                <h2 class="title" data-aos="fade-up" data-aos-delay="700"><?php echo $settings['heading']; ?></h2>
                            <?php endif ?>
