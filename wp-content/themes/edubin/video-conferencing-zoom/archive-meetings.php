...
$edubin_zm_archive_hotted = Edubin::setting( 'edubin_zm_archive_hotted' );
$edubin_zm_archive_start_date = Edubin::setting( 'edubin_zm_archive_start_date' );
$edubin_zm_archive_time_zone = Edubin::setting( 'edubin_zm_archive_time_zone' );
$edubin_zm_excerpt = Edubin::setting( 'edubin_zm_excerpt' );
?>
